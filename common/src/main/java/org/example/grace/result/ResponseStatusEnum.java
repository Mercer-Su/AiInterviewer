...
public enum ResponseStatusEnum {
    ...
    USER_INFO_NOT_EXIST_ERROR(5093,false,"您没有面试邀约！"),
    USER_ALREADY_DID_INTERVIEW_ERROR(5097,false,"您已面试过，请耐心等候通知！"),
    USER_INFO_WAITING_REVIEW_ERROR(5095,false,"用户信息等待审核，请勿重复提交！"),
    USER_FACE_WAITING_REVIEW_ERROR(5096,false,"用户头像等待审核，请勿重复上传！"),
    ...
    USER_FORBIDDEN_ERROR(519,false,"用户禁止访问，请联系管理员！"),
    ...
    CAN_NOT_DELETE_INTERVIEWER(571, false, "当前数字人被面试题库或职位依赖，无法删除！"),
    CAN_NOT_DELETE_JOB(572, false, "当前岗位被候选人关联，无法删除！"),
